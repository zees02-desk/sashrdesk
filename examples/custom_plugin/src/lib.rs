use libsashrdesk::api::RustDeskApiTable;
/// This file demonstrates how to write a custom plugin for SASHRDesk.
...
lazy_static::lazy_static! {
    ...
    // Do your own logic based on the API provided by SASHRDesk.
