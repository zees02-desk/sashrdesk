...
const IDD_IMPL_RUSTDESK: &str = "sashrdesk_idd";
...
pub fn plug_in_headless() -> ResultType<()> {
    match IDD_IMPL {
        IDD_IMPL_RUSTDESK => sashrdesk_idd::plug_in_headless(),
...
pub fn get_platform_additions() -> serde_json::Map<String, serde_json::Value> {
    ...
    match IDD_IMPL {
        IDD_IMPL_RUSTDESK => {
            let virtual_displays = sashrdesk_idd::get_virtual_displays();
...
pub fn plug_in_monitor(idx: u32, modes: Vec<virtual_display::MonitorMode>) -> ResultType<()> {
    match IDD_IMPL {
        IDD_IMPL_RUSTDESK => sashrdesk_idd::plug_in_index_modes(idx, modes),
    ...
    match IDD_IMPL {
        IDD_IMPL_RUSTDESK => {
            let indices = if index == -1 {
                sashrdesk_idd::get_virtual_displays()
            } else {
                vec![index as _]
            };
            sashrdesk_idd::plug_out_peer_request(&indices)
        }
...
pub fn plug_in_peer_request(modes: Vec<Vec<virtual_display::MonitorMode>>) -> ResultType<Vec<u32>> {
    match IDD_IMPL {
        IDD_IMPL_RUSTDESK => sashrdesk_idd::plug_in_peer_request(modes),
        IDD_IMPL_AMYUNI => {
...
pub fn plug_out_monitor_indices(indices: &[u32]) -> ResultType<()> {
    match IDD_IMPL {
        IDD_IMPL_RUSTDESK => sashrdesk_idd::plug_out_peer_request(indices),
        IDD_IMPL_AMYUNI => {
