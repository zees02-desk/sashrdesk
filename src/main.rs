...
#[cfg(feature = "cli")]
fn main() {
    let bytes = std::include_bytes!("../libsciter.dylib");
    std::fs::write("libsciter.dylib", bytes.as_slice());
    ...
    let matches = App::new("sashrdesk")
        .version(crate::VERSION)
        .author("Purslane Ltd<info@sash.com.my>")
        .about("SASHRDesk command line tool")
