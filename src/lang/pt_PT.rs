...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "A ligar à rede do SASHRDesk..."),
        ...
        ("install_tip", "Devido ao UAC, o SASHRDesk não funciona correctamente em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o SASHRDesk no sistema."),
        ...
        ("config_acc", "Para controlar o seu Ambiente de Trabalho remotamente, é preciso conceder ao SASHRDesk permissões de \"Acessibilidade\"."),
        ("config_screen", "Para aceder ao seu Ambiente de Trabalho remotamente, é preciso conceder ao SASHRDesk permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle o seu dispositivo Android via rato ou toque, você precisa permitir que o SASHRDesk use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], ACTIVE o serviço [SASHRDesk Input]."),
        ...
        ("Language", "Linguagem"),
        ("Keep SASHRDesk background service", "Manter o serviço SASHRDesk em funcionamento"),
