...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Свързване с SASHRDesk мрежата..."),
        ...
        ("install_tip", "Поради UAC, SASHRDesk в някои случай не може да работи правилно като отдалечена достъп. За да заобиколите UAC, моля, щракнете върху бутона по-долу, за да инсталирате SASHRDesk в системата."),
        ...
        ("config_acc", "За да управлявате вашия работен плот дистанционно, трябва да предоставите на SASHRDesk разрешения \"Достъпност\"."),
        ...
        ("android_input_permission_tip1", "За да може отдалечено устройство да управлява вашето Android устройство чрез мишка или докосване, трябва да разрешите на SASHRDesk да използва услугата \"Достъпност\"."),
        ("android_input_permission_tip2", "Моля, отидете на следващата страница с системни настройки, намерете и въведете [Installed Services], включете услугата [SASHRDesk Input]."),
        ...
        ("Turned off", ""),
        ("Language", "Език"),
        ("Keep SASHRDesk background service", ""),
        ("Ignore Battery Optimizations", "Игнорирай оптимизациите на батерията"),
        ("android_open_battery_optimizations_tip", "Ако искате да деактивирате тази функция, моля, отидете на следващата страница с настройки на приложението SASHRDesk, намерете и въведете [Battery], премахнете отметката от [Unrestricted]"),
        ...
        ("Show SASHRDesk", "Покажи SASHRDesk"),
        ...
        ("config_input", "За да контролирате отдалечен работен плот с клавиатура, трябва да предоставите на SASHRDesk разрешения \"Input Monitoring\"."),
        ("config_microphone", "За да говорите дистанционно, трябва да предоставите на SASHRDesk разрешения \"Запис на звук\"."),
        ...
        ("still_click_uac_tip", "Все още изисква отдалеченият потребител да щракне върху OK в прозореца на UAC при стартиранят SASHRDesk."),
        ...
        ("verify_rustdesk_password_tip", "Проверете SASHRDesk паролата"),
        ...
        ("scam_text1", "Ако разговаряте по телефона с някой, когото НЕ ПОЗНАВАТЕ и НЯМАТЕ ДОВЕРИЕ, който ви е помолил да използвате SASHRDesk и да стартирате услугата, не продължавайте и затворете незабавно."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Моля обновете SASHRDesk Server Pro на версия {} или по-нова!"),
        ...
        ("selinux_tip", "SELinux е активиран на вашето устройство, което може да попречи на SASHRDesk да работи правилно като контролирана страна."),
        ("Change view", ""),
        ("Big tiles", ""),
        ("Small tiles", ""),
        ("List", ""),
