...
///
/// Note:
/// On linux, we use dbus to communicate multiple sashrdesk process.
...
const DBUS_NAME: &str = "org.sash.sashrdesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "SASHRDesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.sash.sashrdesk /dbus org.sash.sashrdesk.NewConnection string:'PEER_ID'`
