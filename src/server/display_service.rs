...
// https://github.com/Zees02/rustdesk/discussions/6042, avoiding dbus call
...
pub(super) fn get_original_resolution(
    ...
    #[cfg(windows)]
    let is_sashrdesk_virtual_display =
        crate::virtual_display_manager::sashrdesk_idd::is_virtual_display(&display_name);
    #[cfg(not(windows))]
    let is_sashrdesk_virtual_display = false;
    Some(if is_sashrdesk_virtual_display {
        Resolution {
            width: 0,
            height: 0,
            ..Default::default()
