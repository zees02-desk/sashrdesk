...
pub fn is_rustdesk() -> bool {
    hbb_common::config::APP_NAME.read().unwrap().eq("SASHRDesk")
}
...
pub fn get_api_server(api: String, custom: String) -> String {
    ...
    "https://admin.sash.com.my".to_owned()
}

pub fn get_audit_server(api: String, custom: String, typ: String) -> String {
    let url = get_api_server(api, custom);
    if url.is_empty() || url.contains("sash.com.my") {
        return "".to_owned();
    }
...
pub fn check_process(arg: &str, mut same_uid: bool) -> bool {
    ...
    for (_, p) in sys.processes().iter() {
        ...
        // on mac, p.cmd() get "/Applications/SASHRDesk.app/Contents/MacOS/SASHRDesk", "XPC_SERVICE_NAME=com.carriez.RustDesk_server"
...
#[inline]
pub fn sashrdesk_interval(i: Interval) -> ThrottledInterval {
...
mod tests {
    ...
    async fn test_RustDesk_interval() {
        ...
        for maker in base_intervals.into_iter() {
            ...
            let mut timer = sashrdesk_interval(maker());
