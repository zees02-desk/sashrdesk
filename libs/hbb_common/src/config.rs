...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("SASHRDesk".to_owned());
...
pub const LINK_DOCS_HOME: &str = "https://sash.com.my/docs/en/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://sash.com.my/docs/en/manual/linux/#x11-required";
pub const LINK_HEADLESS_LINUX_SUPPORT: &str =
    "https://github.com/rustdesk/rustdesk/wiki/Headless-Linux-Support";
lazy_static::lazy_static! {
    pub static ref HELPER_URL: HashMap<&'static str, &'static str> = HashMap::from([
        ("sashrdesk docs home", LINK_DOCS_HOME),
        ("sashrdesk docs x11-required", LINK_DOCS_X11_REQUIRED),
        ("sashrdesk x11 headless", LINK_HEADLESS_LINUX_SUPPORT),
        ]);
}
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["sashdesk.ddns.net"];
pub const PUBLIC_RS_PUB_KEY: &str = "xNCwY5UuVtOegnuVJRY2p+V24iMf7s0dn6BfYE135Mc=";
