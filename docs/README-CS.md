<p align="center">
  <img src="../res/logo-header.svg" alt="SASHRDesk – vaše vzdálená plocha"><br>
  ...
  <b>Potřebujeme Vaši pomoc s překladem tohoto README, <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">uživatelského rozhraní aplikace SASHRDesk</a> a <a href="https://github.com/rustdesk/doc.sash.com.my">dokumentace k ní</a> do vašeho jazyka</b>
</p>
...
Zase další software pro přístup k ploše na dálku, naprogramovaný v jazyce Rust. Funguje hned tak, jak je – není třeba žádného nastavování. Svá data máte ve svých rukách, bez obav o zabezpečení. Je možné používat námi poskytovaný propojovací/předávací (relay) server, [vytvořit si svůj vlastní](https://sash.com.my/server), nebo [si dokonce svůj vlastní naprogramovat](https://github.com/rustdesk/rustdesk-server-demo), budete-li chtít.

Projekt SASHRDesk vítá přiložení ruky k dílu od každého. Jak začít se dozvíte z [`docs/CONTRIBUTING.md`](CONTRIBUTING.md).

[**Jak SASHRDesk funguje?**](https://github.com/rustdesk/rustdesk/wiki/How-does-SASHRDesk-work%3F)
...
## [Sestavení ze zdrojových kódů](https://sash.com.my/docs/en/dev/build/)
...
- **[src/rendezvous_mediator.rs](https://github.com/rustdesk/rustdesk/tree/master/src/rendezvous_mediator.rs)**: komunikace s [sashrdesk-server](https://github.com/rustdesk/rustdesk-server), očekávání vzdálených příméhých („proděrováváním“ TCP) nebo předávaných (relay) spojení
