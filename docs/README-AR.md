<p align="center">
  ...
  <b>  لغتك الأم,  <a href="https://github.com/rustdesk/doc.sash.com.my">Doc</a> و <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">SASHRDesk UI</a>, README نحن بحاجة إلى مساعدتك لترجمة هذا </b>
</p>
...
[جهز لنفسك واحدا](https://sash.com.my/server), أو
[خاص بك rendezvous/relay أكتب خادم](https://github.com/rustdesk/rustdesk-server-demo).

![image](https://user-images.githubusercontent.com/71636191/171661982-430285f0-2e12-4b1d-9957-4a58e375304d.png)

لمساعدتك على ذلك [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) يرحب بمساهمة الجميع. اطلع على  SASHRDesk.

[**؟ SASHRDesk كيفية يعمل**](https://github.com/rustdesk/rustdesk/wiki/How-does-SASHRDesk-work%3F)
...
## [البناء](https://sash.com.my/docs/en/dev/build/)
...
SASHRDesk يرجى التأكد من أنك تنفذ هذه الأوامر من جذر مستودع
...
- **[src/rendezvous_mediator.rs](https://github.com/rustdesk/rustdesk/tree/master/src/rendezvous_mediator.rs)**: أو المنقول عن بُعد (TCP hole punching) انتظر الاتصال المباشر [sashrdesk-server](https://github.com/rustdesk/rustdesk-server) الإتصال ب
